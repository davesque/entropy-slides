  ...
  \begin{frame}{Basic Concepts}
    ...
    \begin{figure}
      \begin{tikzpicture}[scale=0.5]
        \draw [thick,->] (-2,0.5) -- (-0.2,0.5);
        \node [left] at (-2,0.5) {\footnotesize source};

        \draw [thick,->] (0.5,-2) -- (0.5,-0.2);
        \node [below] at (0.5,-2) {\footnotesize noise};

        \draw [ultra thick] (0,0) rectangle (1,1);
        \node [above] at (0.5,1) {\footnotesize transmitter};

        \draw [thick,->] (1.2,0.5) -- (10.8,0.5);
        \node [above] at (6,0.5) {\footnotesize channel};

        \draw [thick,->] (6,-2) -- (6,0.3);
        \node [below] at (6,-2) {\footnotesize noise};

        \draw [ultra thick] (11,0) rectangle (12,1);
        \node [above] at (11.5,1) {\footnotesize receiver};

        \draw [thick,->] (11.5,-2) -- (11.5,-0.2);
        \node [below] at (11.5,-2) {\footnotesize noise};

        \draw [thick,->] (12.2,0.5) -- (14,0.5);
        \node [right] at (14,0.575) {\footnotesize received};
      \end{tikzpicture}
